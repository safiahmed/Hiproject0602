...
//print_r($cat_id_index);
?>
<?php
require_once './assets/my-controller.php';
$product = new Users();
$data = array();
$pro_detail1 = $product->index_subcategorylink_name($cat_id_index);
//print_r($pro_detail1);
$cat_id3=$pro_detail1['subcat_id_pk'];
$subcat_name=$pro_detail1['subcat_name'];
$cat_id=$pro_detail1['cat_id_fk'];
//print_r($subcat_name);
                ...
                <body>	
                    ...
                    <div id="wrapper">
                        ...
                        <div id="page">
                            ...
                            <?php include 'sucategory_links.php'; ?>	
                            <div class="col2-left-layout">
                                <div class="col-main">

                                    <div class="main-title category_title">
                                        <h1><?php echo $pro_detail1['subcat_name']; ?></h1>
                                    </div>
                                    <div class="embedded_category">
                                        <div class="cat_main_content">
                                            <p style="text-align: justify; font-size:12px;"><?php echo $pro_detail1['subcat_desc']; ?> </p>
                                        </div>
                                    </div>
                                    <div class="toolbar">
                                    ...
                                    <div class="middle_boxes">
                                        <?php include 'subcategory-grid-view.php'; ?>
                                        <div id="list-view">
                                            <?php include 'subcategory-list-view.php'; ?> 
                                        </div>
                                    </div>
                                </div>
