...
<link href="css/update_profile.css" rel="stylesheet" type="text/css" media="screen" />
    ...
    <div id="khajafooter"> 
		...
		<div>
				<label>
					...
					<input placeholder="Please enter your email address" type="email" tabindex="2" name="email" id="input_type" required><br/><br/>
				</label>
			</div>
			...
			<div>
				<label>
					...
					<input type="text" tabindex="1" name="fname" id="input_type"><br/><br/>
				</label>
			</div>
				<div>
				<label>
					<span>Last Name:</span>
					<input type="text" tabindex="1" name="lname" id="input_type"><br/><br/>
				</label>
			</div>
			...
			<div id="send">
				 <br/><a href="unsubscribe.php" style="background-color:#336699;font-family: Trebuchet MS; font-size:16px;color:white;text-decoration:none;padding:3px 3px 3px 3px;margin-left:300px;float:left;margin-top:-34px">Unsubscribe</a>
			</div>
