 ...
 .table-view{
    display:none;
                ...
                <col>
                    ...
                    <tr class="newheader1">
                       <th rowspan="1" width="50">Sl.no</th>
                        <th rowspan="1" width="150">Item name</th>
                        <th rowspan="1" width="200"><span class="nobr">Item Code / Voucher(s)</span></th>
                        
                        						<!--<th rowspan="1" class="a-center" width="100">Edit</th>-->
                        <th width="150"><span class="nobr">Status</span></th>
                        <th width="10">Quantity</th>
                        <th class="a-center last" colspan="1">Price</th>
                ...
                <tbody>
                                    <tr class="odd">
	<td class="cart-table-img" style="padding: 10px 40px;">1.</td>
    <td>Hospital Billing Application
	...
	<tr>
		<td bgcolor="#f8f8f8">
			...
			<tr>
				<td width="60%" style="padding-left:30px;margin-right:40px">
				...
				<td  align="right" style="padding:15px 25px 15px 0px;" valign="top" class="segoe totalprice">
					<div style="margin-right:-23px;padding-right:10px;">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
					...
					<tr>
						<td width="300" align="right" height="24">
							Shipping Charges
						</td>
						<td align="right">
					...
					<tr>
						<td width="300" align="right" height="24" style="font-size:15px;">
