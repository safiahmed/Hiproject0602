...
<div id="gallery_01" style="margin-top: -200px;">
 ...
 <li>  <a href="#" class="elevatezoom-gallery " data-update="" data-image="images/small/1.jpg" data-zoom-image="images/large/2 Rx (1).jpg" >
<img src="images/thumb/2 Rx (1) copy.jpg" width="100"></a> </li>

    <li>  <a href="#" class="elevatezoom-gallery " data-update="" data-image="images/small/2.jpg"  data-zoom-image="images/large/2 Rx (2).jpg" >
<img src="images/thumb/2 Rx (2) copy.jpg" width="100"></a> </li>

    <li>  <a href="#" class="elevatezoom-gallery "  data-update="" data-image="images/small/3.jpg" data-zoom-image="images/large/2 Rx (3).jpg">
<img src="images/thumb/2 Rx (3) copy.jpg" width="100"></a> </li>
...
$("#zoom_03").bind("click", function(e) {  
  ...
  return false;
	...
	<div class="price-box">Kit No: <span style="color:#E72E1E;">180</span></div>
	 <div class="price-box"><a href="">View Kit price</a></div>
	 <div class="price-box"><img src="images/icon-add-to-wishlist2.png"/><a href="mywishlistnew.php"> Add Your Wishlist</a></div>
	 	<div class="ratings">
                    <div class="rating-box">
                <div class="rating" style="width:80%"></div>
            </div>
                <div class="price-box"><a href="#review">3 Review(s)</a></div>
    </div>
		 ...
		 <div class="price-box">
            ...
            <a href="#">Add to Category</a>
			
        </p>
		<a id="OpenDialog" href="#"><img src="images/b2.jpg"></a>
        </div>
...
<div class="clear"></div>
					...
					<div class="box-content">
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active" id="Video1">
								...
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur bibendum ornare dolor, quis ullamcorper ligula sodales at. Nulla tellus elit, varius non commodo eget, mattis vel eros. In sed ornare nulla. Donec consectetur, velit a pharetra ultricies, diam lorem lacinia risus, ac commodo orci erat eu massa. Sed sit amet nulla ipsum. Donec felis mauris, vulputate sed tempor at, aliquam a ligula. </p>
							</div>
	...
	<ul>
		<div id="idian">
		<li><img src="images/16.png"/></li>
		<li> <span style="color:#bf6008;">Similar Project Kits</span></strong></span> </li>
...
<ol>
    ...
    <strong><span style="color:#FFF;">Already Purchased</span></strong>
	</div>
   </li>
   <li></br></li>
	<li style="margin-left:5px;"> <span style="font-size:12px; ">Name:&nbsp <span style="color: #2071a1;"><b>Rohit Sharma</b></span><span></li>
	<li id="liid"><span style="font-size:12px;"><span style="color: #2071a1;"><a href="#">Auto Intensity Control Of Street Lights</a></span></span></li>
	 <img src="images/thumb/2 Rx (1) copy.jpg" style="margin-left: 32px;
margin-top: 8px;
width: 180px;" />
	
	<li></br></li>
	
	<li><div class="block-title">
        <strong><span><center>Also Purchased</center</span></strong>
		</div>
   </li>
   <!--<li id="liid"><span style="font-size:12px;">Product: <span style="color: #2071a1;">Auto Intensity Control Of Street Lights</span></span></li>
   <img src="images/thumb/2 Rx (1) copy.jpg" style="margin-left: 32px;
margin-top: 8px;
width: 180px;" />-->
	</ol>
	...
	<ol class="mini-products-list" id="block-related">
                ...
                <div class="product">
                    ...
                    <div class="product-details">
                        <p class="product-name1"><a href="#">Lorem ipsum dolor sit amet, quisque lacinia nisi in neque.</a></p>
