										 ...
										 <div id="account-info" class="middle_box1">
										     ...
										     <form role="form">
                                              ...
                                              <p style="padding-left:57px;padding-top:13px;color:#939391;">First Name
                                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="email" class="form-control" id="exampleInputEmail1" value="Sachin"></p>
													</div>
													<div class="form-group">
                                              <p style="padding-left:55px;color:#939391;">Last Name 
                                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="email" class="form-control" id="exampleInputEmail1" value="K R"></p>
													</div>
													<div class="form-group">
                                              <p style="padding-left:50px;color:#939391;">Mobile Number
                                                 &nbsp;&nbsp;&nbsp;<input type="email" class="form-control" id="exampleInputEmail1" value="+9963153668"></p>
													</div></div>
...
<div class="middle_box1">
		...
		<!--</form>-->
													...
													<button type="submit" class="btnsavechanges">Save Changes</button>
															</form> 
										 </div>
