            ...
            <link href="css/jquery-ui-1.8.21.custom.css" rel="stylesheet">
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        $("body").on('click', '#tab1 tbody tr .img_track', function() {
                            var t = $(this).closest("tr");
                            var id = t.children('td').find('input[type="hidden"]').val();
                                $.ajax({
                                    url: 'order-row-details.php',
                                    type: "POST",
                                    data: {orderid: id},
                                    success: function(result) {
                                        t.next().removeClass("hi");
                                        $(".my_order_details").parent().hide();
                                        t.next().children().find(".my_order_details").html(result).parent().css("display","block");
                                    }
                                });
                        });
                                ...
                                <div class="inner_account_content1234" >
                                    <form id="accountform" role="form" action="./assets/controller-links.php" method="post">
                                        <div id="account-info" class="middle_box1">
                                            ...
                                            <h2 style="padding-left:10px;padding-top:10px;">Personal Information</h2>
                                            ...
                                            <input type="hidden" name="reg" value="<?php echo $personalinfo['id']; ?>" ></input>
                                        </div>
                                            ...
                                            <div class="top-sidebar">
                                                ...
                                                <div>
                                                    <label>
                                                        ...
                                                        <input placeholder="Please enter your name" type="text" tabindex="1" name="fname" value="<?php
                                                        if (!empty($memberinfo['fname'])) {
                                                            echo $memberinfo['fname'];
                                                        }
                                                        ?>"    />
                                                    </label>
                                                </div>
                                                ...
                                                <div>
                                                    <label>
                                                        <span>Email</span>
                                                        <input placeholder="Please enter your email address" type="email" tabindex="2" name="femail" value="<?php
                                                        if (!empty($memberinfo['femail'])) {
                                                            echo $memberinfo['femail'];
                                                        }
                                                        ?>" />
                                                    </label>
                                                </div>
                                                <div>
                                                    <label>
                                                        <span>Phone</span>
                                                        <input placeholder="Please enter your number" type="tel" tabindex="3" name="fphone" value="<?php
                                                        if (!empty($memberinfo['fmobile'])) {
                                                            echo $memberinfo['fmobile'];
                                                        }
                                                        ?>"   />
                                                    </label>
                                                </div>
                                        ...
                                        <div class="middle_box1">
                                            <div class="top-sidebar">
                                                ...
                                                <div>
                                                    <label>
                                                        <span>Name</span>
                                                        <input placeholder="Please enter your name" type="text" tabindex="1" name="sname" value="<?php
                                                        if (!empty($memberinfo['sname'])) {
                                                            echo $memberinfo['sname'];
                                                        }
                                                        ?>"    />
                                                    </label>
                                                </div>
                                                ...
                                                <div>
                                                    <label>
                                                        <span>Email</span>
                                                        <input placeholder="Please enter your email address" type="email" tabindex="2" name="semail" value="<?php
                                                        if (!empty($memberinfo['semail'])) {
                                                            echo $memberinfo['semail'];
                                                        }
                                                        ?>"    />
                                                    </label>
                                                </div>
                                                <div>
                                                    <label>
                                                        <span>Phone</span>
                                                        <input placeholder="Please enter your number" type="tel" tabindex="3" name="sphone" value="<?php
                                                        if (!empty($memberinfo['sphone'])) {
                                                            echo $memberinfo['sphone'];
                                                        }
                                                        ?>"   />
                                                    </label>
                                                </div>
                                        ...
                                        <div class="middle_box1">
                                            <div class="top-sidebar">
                                                ...
                                                <div>
                                                    <label>
                                                        <span>Name</span>
                                                        <input placeholder="Please enter your name" type="text" tabindex="1" name="tname" value="<?php
                                                        if (!empty($memberinfo['tname'])) {
                                                            echo $memberinfo['tname'];
                                                        }
                                                        ?>"  />
                                                    </label>
                                                </div>
                                                ...
                                                <div>
                                                    <label>
                                                        <span>Email</span>
                                                        <input placeholder="Please enter your email address" type="email" tabindex="2" name="temail" value="<?php
                                                        if (!empty($memberinfo['temail'])) {
                                                            echo $memberinfo['temail'];
                                                        }
                                                        ?>" />
                                                    </label>
                                                </div>
                                                <div>
                                                    <label>
                                                        <span>Phone</span>
                                                        <input placeholder="Please enter your number" type="tel" tabindex="3" name="tphone" value="<?php
                                                        if (!empty($memberinfo['frphone'])) {
                                                            echo $memberinfo['frphone'];
                                                        }
                                                        ?>" />
                                                    </label>
                                                </div>
                                        ...
                                        <div class="middle_box1">
                                            <div class="top-sidebar">
                                                ...
                                                <div>
                                                    <label>
                                                        <span>Name</span>
                                                        <input placeholder="Please enter your name" type="text" tabindex="1" name="frname" value="<?php
                                                        if (!empty($memberinfo['frname'])) {
                                                            echo $memberinfo['frname'];
                                                        }
                                                        ?>" />
                                                    </label>
                                                </div>
                                                ...
                                                <div>
                                                    <label>
                                                        <span>Email</span>
                                                        <input placeholder="Please enter your email address" type="email" tabindex="2" name="fremail" value="<?php
                                                        if (!empty($memberinfo['fremail'])) {
                                                            echo $memberinfo['fremail'];
                                                        }
                                                        ?>">
                                                    </label>
                                                </div>
                                                <div>
                                                    <label>
                                                        <span>Phone</span>
                                                        <input placeholder="Please enter your number" type="tel" tabindex="3" name="frphone"  value="<?php
                                                        if (!empty($memberinfo['frphone'])) {
                                                            echo $memberinfo['frphone'];
                                                        }
                                                        ?>" >
                                        ...
                                        <?php if (($personalinfo['status']) == 1) {
                                            ?>    
                                            <button type="submit" name="register2" class="btnsavechanges">Save Changes</button>
                                            <?php
                                        } else {
                                            ?>
