    	...
    	<div class="col_allw3008">
			...
			<div>
				...
				<br/>
					...
					<span>Your subscription to our list has been confirmed.</span><br/><br/>
					<span>Thank you for subscribing!</span><br/><br/>
					   <span>  Magnum Technologies </span>
						...
						<span> India</span>
	                    <br/><a href="#" style="background-color:#336699;font-family: Trebuchet MS; font-size:16px;color:white;text-decoration:none;padding:2.5px;margin-left:300px;">Update Profile</a>
				</label>
			</div>
