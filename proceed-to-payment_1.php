            ...
            <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css'>
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        $('.shipaddress_submit').click(function(e) {alert(1);return false;
                                ...
                                <div class="project_kit">
                                    ...
                                    <div class="box-content">
                                        <div class="for-font">
                                            ...
                                            <div id="cart1">
                                                <h3 style="float:left">My detail:</h3>
                                                    <div id="login">
                                                        <?php
                                                        if (!isset($_SESSION['reg_id'])) {
                                                            ?>
                                                    ...
                                                    <form id="newshippingaddress"action="assets/controller-links.php" method="post">
                                                        <div id="cart2">
                                                            ...
                                                            <table>
                                                                ...
                                                                <input type="hidden" name="sessioncart" value="<?php echo $_SESSION['cart_id']; ?>"
                                                                       <tr><td></td><td></td><td>
