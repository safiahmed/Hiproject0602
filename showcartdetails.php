...
<style>
    .cart_details{width: 107%; height: auto; border: 1px solid #ddd; border-radius: 4px; margin-left: -78px;}
    .data-table {width: 100%;}
    .price_values{width: 100%; min-height: 100px;; height: auto;}
    .price_values .left-price{width: 78%; float: left;}
    .price_values .right-price{width:20%; float: left;}
</style>
<!--<a href="#close" title="Close" class="close1">X</a>-->
<div style="clear: both"></div>
<div class="cart_details">
    <h2>Shopping Cart Summary</h2><br>
    <hr>
    <div style="clear: both;"></div>
    <form action="#" method="post">
        <fieldset>
            <table id="shopping-cart-table1" class="data-table cart-table1" style="font-size: 15px;">
                        ...
                        <tr class="odd">
                            <td class="cart-table-img" style="padding: 10px 40px;">
                                <a href="#" title="" class="product-image">
                                    <img src="<?php echo $prod['prod_thumbimage']; ?>" width="150" height="120" alt="">
                                </a>
                            </td>
                            <td>
            ...
            <div class="price_values">
                <div class="left-price">
                    <div class="cart-total-summary"><h3>Cart Summary (<span class="cart-text"></span> Item(s))</h3></div>
                    <div>Select Country
